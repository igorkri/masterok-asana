...
/* @var $searchModel backend\models\search\report\PayerSearch */
                            ...
                            'toolbar' => [
                                ['content' =>
                                    Html::a('<i class="fas fa-plus"></i>', ['create'],
                                        ['role' => 'modal-remote', 'title' => 'Створити', 'class' => 'btn btn-success']) .

                                    Html::a('Рахунки', ['', 'page_type' => \common\models\report\Invoice::PAGE_TYPE_INVOICE],
                                        [
                                                'data-pjax' => 1,
                                            'class' => 'btn btn-warning',
                                            'title' => 'відображати тільки рахунки',
                                            'active' => $page_type === \common\models\report\Invoice::PAGE_TYPE_INVOICE
                                        ]) .

                                    Html::a('Акти', ['', 'page_type' => \common\models\report\Invoice::PAGE_TYPE_ACT],
                                        ['data-pjax' => 1, 'class' => 'btn btn-warning', 'title' => 'відображати тільки акти']) .
                                        ...
                                        'buttons' => Html::a('<i class="far fa-trash-alt"></i>&nbsp; Видалити',
                                            ...
                                            Html::a('Згенерувати рахунки',
                                                ...
                                                [
                                                    ...
                                                    'data-request-method' => 'post',
                                                    'data-confirm-title' => 'Ви впевнені?',
                                                    'data-confirm-message' => 'Ви впевнені, що хочете згенерувати рахунки?'
                                                ]) . ' ' .
