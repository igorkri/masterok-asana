...
<!--                    <a href="#" class="btn btn-primary">Export</a>-->
        ...
        <div class="row g-4 g-xl-5">
            ...
            <div class="col-12 col-lg-4 col-xxl-3 d-flex">
                <?php echo \backend\widgets\ActiveTaskWidget::widget(); ?>
            </div>
            <div class="col-12 col-lg-8 col-xxl-9 d-flex">
                <?php echo \backend\widgets\ChartWidget::widget(); ?>
            </div>
            ...
            <?php echo \backend\widgets\RecentActivityWidget::widget(); ?>
            <?php echo \backend\widgets\RecentReviewsWidget::widget(); ?>
        </div>
    </div>
</div>