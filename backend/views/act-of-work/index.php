...
//                                '{export}',
                            ...
                            'panel' => [
                                ...
                                'before' => "Загальна сума: <b>" .
                                    ...
                                    "</b> | Оплачено: <b>" .
                                    Yii::$app->formatter->asCurrency(array_sum($totlalSum['paid_amount'])) . "</b> | <b>Сума боргу: " . $sumDebit . "</b>" . ' | Зароблено (Timer)<b> ' . Yii::$app->formatter->asCurrency($timerTotalPrice) . '</b>',
